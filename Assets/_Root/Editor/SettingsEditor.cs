    ...
    internal class SettingsEditor : Editor
    {
        ...
        public static Texture2D ChevronDown
        {
            get
            {
                ...
                const string upmPath = UPM_SKIN_PATH + "Icon/icon-chevron-down-dark.psd";
                string path = !File.Exists(Path.GetFullPath(upmPath)) ? SKIN_PATH + "Icon/icon-chevron-down-dark.psd" : upmPath;
        ...
        public static Texture2D ChevronUp
        {
            get
            {
                ...
                const string upmPath = UPM_SKIN_PATH + "Icon/icon-chevron-up-dark.psd";
                string path = !File.Exists(Path.GetFullPath(upmPath)) ? SKIN_PATH + "Icon/icon-chevron-up-dark.psd" : upmPath;
